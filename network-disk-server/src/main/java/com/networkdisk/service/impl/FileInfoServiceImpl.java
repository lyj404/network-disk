...
import com.networkdisk.entity.dto.UploadResultDto;
import com.networkdisk.entity.dto.UserSpaceDto;
import com.networkdisk.entity.enums.*;
...
import com.networkdisk.entity.query.SimplePage;
...
import com.networkdisk.mappers.FileInfoMapper;
import com.networkdisk.mappers.UserInfoMapper;
import com.networkdisk.service.FileInfoService;
import com.networkdisk.utils.DateUtil;
import com.networkdisk.utils.ProcessUtils;
import com.networkdisk.utils.ScaleFilter;
...
//    @Transactional
    ...
    private void cutFile4Video(String fileId, String videoFilePath) {
        ...
        // 将一个视频文件转换为另一个视频文件，它使用了FFmpeg工具来实现。其中，-y表示覆盖输出文件，-i %s表示输入文件，
        // -vcodec copy表示视频编码格式不变，-acodec copy表示音频编码格式不变，-vbsf h264_mp4toannexb表示将H.264编码的MP4格式
        // 转换为Annex B格式。%s是占位符，表示输入文件和输出文件的路径。

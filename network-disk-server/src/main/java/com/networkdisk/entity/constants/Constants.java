package com.networkdisk.entity.constants;
...
public class Constants {
    ...
    // redis中邮箱消息的键
    public static final String REDIS_KEY_SYS_SETTING = "networkdisk:syssetting";
    ...
    public static final String REDIS_KEY_DOWNLOAD = "networkdisk:download:";


    public static final String REDIS_KEY_USER_SPACE_USE = "networkdisk:user:spaceuse:";

    public static final String REDIS_KEY_USER_FILE_TEMP_SIZE = "networkdisk:user:file:temp";
